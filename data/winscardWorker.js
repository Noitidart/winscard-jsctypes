...
self.onmessage = function (msg) {
	...
	WORKER[msg.data.shift()].apply(WORKER, msg.data);
}
...
/*var myExtension =
    {
        ...
        function SCardEstablishContextFUNC(aCallbackName)
        {
			...
			self.postMessage([aCallbackName, reader_names.toString(), hSC.toString()]);
        }
...
function dec2Hex(dec)
{
    ...
    return result;
         ...
         function Transmit(evt)/*(SCardTransmit, hCard, AProtocol)*/{
            try{
